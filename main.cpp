...
public:
    ...
    static void satc_04(){
        StudyPinkProgram * studyinpink = new StudyPinkProgram("D:\\btl2\\intial\\sa_tc_02_config");
        studyinpink->run(true);
        delete studyinpink;
    }
    static void satc_05(){
        StudyPinkProgram * studyinpink = new StudyPinkProgram("TestCase1.txt");
        studyinpink->run(true);
        delete studyinpink;
    }
};
